...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CMSG_QUICK_JOIN_AUTO_ACCEPT_REQUESTS, STATUS_AUTHED, PROCESS_THREADUNSAFE, &WorldSession::HandleQuickJoinAutoAcceptRequests);    // <WIP>
    ...
    DEFINE_HANDLER(CMSG_REPORT_ENABLED_ADDONS,                              STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleReportEnabledAddons);
    DEFINE_HANDLER(CMSG_REPORT_KEYBINDING_EXECUTION_COUNTS,                 STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleReportKeybindingExecutionCounts);
    ...
    DEFINE_HANDLER(CMSG_REQUEST_WOW_TOKEN_MARKET_PRICE,                     STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleRequestWowTokenMarketPrice);
...
#define DEFINE_SERVER_OPCODE_HANDLER(opcode, status, con) \
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_WARDEN3_ENABLED, STATUS_NEVER, CONNECTION_TYPE_REALM);
