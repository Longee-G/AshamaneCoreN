...
enum OpcodeClient : uint16
{
    ...
    CMSG_BATTLE_PAY_QUERY_CLASS_TRIAL_BOOST_RESULT    = 0x36C3, // or `CMSG_CHARACTER_CHECK_UPGRADE`
    CMSG_BATTLE_PAY_REQUEST_CHARACTER_BOOST_UNREVOKE  = 0x36C1, // or `CMSG_CHARACTER_UPGRADE_MANUAL_UNREVOKE_REQUEST`
    CMSG_BATTLE_PAY_REQUEST_CURRENT_VAS_TRANSFER_QUEUES = 0x3708,   // or `CMSG_VAS_GET_SERVICE_STATUS`
    CMSG_BATTLE_PAY_REQUEST_VAS_CHARACTER_QUEUE_TIME  = 0x3709,     // or `CMSG_VAS_GET_QUEUE_MINUTES`
    CMSG_BATTLE_PAY_PURCHASE_PRODUCT = 0x36C8,                      // or `CMSG_BATTLE_PAY_START_PURCHASE`
    CMSG_BATTLE_PAY_START_PURCHASE                    = 0x36F2,     // or `CMSG_GET_VAS_TRANSFER_TARGET_REALM_LIST`
    CMSG_BATTLE_PAY_TRIAL_BOOST_CHARACTER             = 0x36C2,     // or `CMSG_CHARACTER_UPGRADE_START`
    CMSG_BATTLE_PAY_PURCHASE_DETAILS_RESPONSE               = 0x370B,   // or `CMSG_BATTLE_PAY_OPEN_CHECKOUT`
    CMSG_BATTLE_PAY_PURCHASE_UNK_RESPONSE                   = 0x370D,   // Unk
    CMSG_BATTLE_PAY_VALIDATE_BNET_VAS_TRANSFER        = 0x370A,         // or `CMSG_VAS_CHECK_TRANSFER_OK`
    // <WIP> bpay
    ...
    CMSG_CHECK_WOW_TOKEN_VETERAN_ELIGIBILITY          = 0x36E9, // or CMSG_CONSUMABLE_TOKEN_CAN_VETERAN_BUY
