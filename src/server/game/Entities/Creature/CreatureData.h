...
typedef std::vector<Difficulty> DifficultyVector;
...
struct CreatureData
{
    ...
    // issue(#4)
    //uint64 spawnMask;
    DifficultyVector spawnDifficulties;                     // creature can spawn in this difficulty list (https://github.com/Longee-G/AshamaneCoreN/issues/4)
    uint64 npcflag;
    uint32 unit_flags;                                      // enum UnitFlags mask values
    uint32 unit_flags2;                                     // enum UnitFlags2 mask values
    uint32 unit_flags3;                                     // enum UnitFlags3 mask values
