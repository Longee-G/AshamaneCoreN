...
class TC_GAME_API MotionMaster
{
    ...
    public:
        ...
        */
        ...
        void MoveCharge(Position const* pos, float speed = SPEED_CHARGE, uint32 id = EVENT_CHARGE, bool generatePath = false, Unit const* target = nullptr, Movement::SpellEffectExtraData const* spellEffectExtraData = nullptr);
