...
(@PATH+0,4,1142.81,3197.18,43.5603,0,0,1,0,100,0),	-- takeoff
-- (@PATH+0,5,1131.93,3194.71,43.2108,0,0,1,0,100,0), -- pos in the air
...
/*
DELETE FROM `waypoint_data` WHERE `id` IN (9822800, 9822801);
...
(10267108,4,1141.28,3207.38,44.871,0,0,3,0,100,0),	-- takeoff

(10267108,5,1131.1,3204.25,44.9873,0,0,2,0,100,0),
...
DELETE FROM `waypoint_data` WHERE `id` IN (9822700, 9822701);
...
(10267109,4,1139.73,3204.31,43.8143,0,0,3,0,100,0),	-- takeoff
...
DELETE FROM `waypoint_data` WHERE `id` IN (9991800, 9991801);
...
(10267110,4,1139.25,3199.53,42.8941,0,0,3,0,100,0), -- takeoff

(10267110,5,1131.05,3197,42.6448,0,0,2,0,100,0),
(10267110,6,1119.06,3192.96,35.9639,0,0,2,0,100,0),
...
DELETE FROM `waypoint_data` WHERE `id` IN (9829200, 9829201);
...
(10267111,4,1131.84,3194.26,43.748,0,0,3,0,100,0),	-- takeoff
...
DELETE FROM `waypoint_data` WHERE `id` IN (9829000, 9829001);
...
(10267112,4,1130.64,3193.69,41.6789,0,0,3,0,100,0),	-- takeoff
